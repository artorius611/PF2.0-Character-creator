...
class Dwarf :
    def __init__ (self, strength, dexterity, constitution, intelligence, wisdom, charisma, health, speed, dwarf) :
        ...
        while heritage_input == "false":
            ...
            if choice == '1' :
                heritage_input = "true"
                Character_feats['ancestry feats'][1] = self.dwarf['heritage']["Ancient-Blooded"]
            elif choice == '2' :
                heritage_input = "true"
                Character_feats['ancestry feats'][1] = self.dwarf['heritage']['Desert Dwarf']
            elif choice == '3' :
                heritage_input = "true"
                Character_feats['ancestry feats'][1] = self.dwarf['heritage']['Stronghearted Dwarf']
            elif choice == '4' :
                heritage_input = "true"
                Character_feats['ancestry feats'][1] = self.dwarf['heritage']['Unburdened Dwarf']
        else:
